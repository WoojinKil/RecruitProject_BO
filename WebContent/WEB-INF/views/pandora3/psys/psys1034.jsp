...
$(document).ready(function(){
    var grid_config = {
        ...
        columns   : [
                      ...
                      {name : 'APPL_STAT_CD', label : '상태', editable : true, edittype : 'select', formatter : 'select',
                    	  editoptions : {
                      ...
                      {name : 'APPL_DT', label : '신청일자', editable : false},
                     ],
        editmode    : true,                                     // 그리드 editable 여부
        gridtitle   : '포탈 권한 신청 목록',                                  // 그리드명
        multiselect : true,                                     // checkbox 여부
        formid      : 'search',                                 // 조회조건 form id
        height      : 480,                                      // 그리드 높이
        shrinkToFit : true,                                     // true인경우 column의 width 자동조정, false인경우 정해진 width대로 구현(가로스크롤바필요시 false)
        selecturl   : '/psys/getPsys1034List.adm',              // 그리드 조회 URL
        saveurl     : '/psys/savePsys1034List.adm',             // 그리드 입력/수정/삭제 URL
        search      : true,
        events      : {
