...
$(document).ready(function(){
	...
	var grid_config = { 
		...
		columns	  : [
        	{name : 'USR_ID', label : '유저 아이디', hidden : true},
			{name : 'USR_NM', label : '유저 이름', align : 'center', width : 40},
			{name : 'USR_PGM_BTN', label : '사용자 버튼', hidden : true},
			{name : 'APPL_DT', label : '신청일자', width : 80},
			{name : 'SYS_CD', label : '사이트번호', align : 'center', width : 40},
...
// 		initval		: {US_YN : 'Y', SORT_ORD : 999, MST_CD : 'A00'}, // 컬럼 add 시 초기값
		...
		selecturl	: '/psys/getPsys1036AdmMnuApplList', 				// 그리드 조회 URL
