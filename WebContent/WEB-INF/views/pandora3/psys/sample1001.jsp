...
$(document).ready(function(){
    ...
    var menu_config = { 
		...
		columns		: [
			...
			{name : 'MIDD_MNU_SEQ' , label : '상위메뉴', editable : false, width : 60},
...
function fn_Search()
{
    ...
    /* var row = role_grid.getRowData(0);
    console.log(row);
    if(isNotEmpty(row.ROL_ID))
    {
    	$("#mnu_btn").data("row", 0);
					...
					<div class="gd_col_6"> 
						<!-- <div class="tableBtnWrap gridBtn">
							<div id="btn_menu_grid" class="tableBtn">
								<button class="b_common btn_default" id="btn_menu_add">행추가</button>
