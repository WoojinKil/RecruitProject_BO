    ...
    var settings = {}, roots = {}, caches = {},
        ...
        _eventProxy = function (event) {
            ...
            if (tools.eqs(event.type, "mousedown")) {
                ...
                if (tools.eqs(target.tagName, "span") && target.getAttribute("treeNode" + consts.id.SWITCH) !== null) {
                    ...
                    if($("#" + tId).find("#" + tId + "_ul > li").length == 0) {
                    	console.log("length 0");
                    	console.log($("#" + tId).find("#" + tId + "_switch"));
                    	$("#" + tId).find("#" + tId + "_switch").addClass("11111");
                    }
                } else {
        ...
        view = {
            ...
            makeUlHtml: function (setting, node, html, content) {
                html.push("<ul id='", node.tId, consts.id.UL, "' class='", consts.className.LEVEL, node.level, " line ", view.makeUlLineClass(setting, node), "' style='display:", (node.open ? "block" : "none"), "'>");
                html.push(content);
                html.push("</ul>");
            },
